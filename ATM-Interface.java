...
class Bank
{
    ...
    public static void login() {
        ...
        if(accounts.containsKey(accno))
        {
            ...
            {
                System.out.println("Please Enter Correct Pin for Your Account Number."+accno);
            }
        }
        else
    ...
    public static void Deposit(int accno) {
        ...
        int cash=sc.nextInt();
        System.out.println("Your Amount of Rs."+cash+"is Credited in your Account.");
            String amount=accounts.get(accno).get(2);
            int amount1=Integer.parseInt(amount);
            amount1+=cash;
            amount=String.valueOf(amount1);
